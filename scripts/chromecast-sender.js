...
CastPlayer.prototype.setupLocalPlayer = function () {
    ...
    playerTarget.load = function(mediaIndex) {
        console.log("LocalPlayer: Load - " + mediaIndex);
    ...
    playerTarget.setVolume = function(volumeSliderPosition) {
        console.log("LocalPlayer: setVolume - " + volumeSliderPosition);
    ...
    playerTarget.mute = function() {
        console.log("LocalPlayer: Mute")

        //localPlayer.muted = true;
    };

    playerTarget.unMute = function() {
        console.log("LocalPlayer: unMute")
    ...
    playerTarget.seekTo = function(time) {
        console.log("LocalPlayer: seekTo - " + time);
